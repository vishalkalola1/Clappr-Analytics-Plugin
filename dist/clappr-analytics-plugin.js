(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ClapprAnalyticsPlugin"] = factory(require("clappr"));
	else
		root["ClapprAnalyticsPlugin"] = factory(root["Clappr"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _clappr=__webpack_require__(55);var _socket=__webpack_require__(54);var _socket2=_interopRequireDefault(_socket);var _deviceinfo=__webpack_require__(53);var _deviceinfo2=_interopRequireDefault(_deviceinfo);var _utils=__webpack_require__(26);var _utils2=_interopRequireDefault(_utils);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var PlayerService=function(_ContainerPlugin){_inherits(PlayerService,_ContainerPlugin);function PlayerService(container){_classCallCheck(this,PlayerService);var _this=_possibleConstructorReturn(this,(PlayerService.__proto__||Object.getPrototypeOf(PlayerService)).call(this,container));_this.deviceinfo=new _deviceinfo2.default();_this.utis=new _utils2.default();_this.fullscreen=false;_this.analysisdata=container.options.analyticsdata;if(_this.analysisdata){_this.socketservice=new _socket2.default(_this.analysisdata,_this.deviceinfo,_this.utis);if(_this.socketservice){_this.addEventListeners();}}return _this;}_createClass(PlayerService,[{key:'addEventListeners',value:function addEventListeners(){var _this2=this;if(this.container){this.listenTo(this.container,_clappr.Events.CONTAINER_READY,this.onReady);this.listenTo(this.container,_clappr.Events.CONTAINER_PLAY,this.onPlay);this.listenTo(this.container,_clappr.Events.CONTAINER_STOP,this.onStop);this.listenTo(this.container,_clappr.Events.CONTAINER_PAUSE,this.onPause);this.listenTo(this.container,_clappr.Events.CONTAINER_ENDED,this.onEnded);this.listenTo(this.container,_clappr.Events.CONTAINER_STATE_BUFFERING,this.onBuffering);this.listenTo(this.container,_clappr.Events.CONTAINER_STATE_BUFFERFULL,this.onBufferFull);this.listenTo(this.container,_clappr.Events.CONTAINER_ERROR,this.onError);this.listenTo(this.container,_clappr.Events.CONTAINER_PLAYBACKSTATE,this.onPlaybackChanged);this.listenTo(this.container,_clappr.Events.CONTAINER_VOLUME,function(event){return _this2.onVolumeChanged(event);});this.listenTo(this.container,_clappr.Events.CONTAINER_SEEK,function(event){return _this2.onSeek(event);});this.listenTo(this.container,_clappr.Events.CONTAINER_FULLSCREEN,this.onFullscreen);this.listenTo(this.container,_clappr.Events.CONTAINER_HIGHDEFINITIONUPDATE,function(event){return _this2.onHD(event);});this.listenTo(this.container,_clappr.Events.CONTAINER_PLAYBACKDVRSTATECHANGED,this.onDVR);}}},{key:'onReady',value:function onReady(){var o={type:'Playback',value:'',name:this.container.playback.name};this.push(o);}},{key:'onPlay',value:function onPlay(){var o={type:'Play',value:'',name:this.container.playback.src};this.push(o);}},{key:'onStop',value:function onStop(){var o={type:'stop',value:'',name:this.container.playback.src};this.push(o);}},{key:'onEnded',value:function onEnded(){var o={type:'Ended',value:'',name:this.container.playback.src};this.push(o);}},{key:'onBuffering',value:function onBuffering(){var o={type:'Buffering',value:'',name:this.container.playback.src};this.push(o);}},{key:'onBufferFull',value:function onBufferFull(){var o={type:'BufferFull',value:'',name:this.container.playback.src};this.push(o);}},{key:'onError',value:function onError(){var o={type:'Error',value:'',name:this.container.playback.src};this.push(o);}},{key:'onHD',value:function onHD(isHD){var status=isHD?'ON':'OFF';if(status!==this.currentHDState){this.currentHDState=status;var o={type:'HD',value:status,name:this.container.playback.src};this.push(o);}}},{key:'onPlaybackChanged',value:function onPlaybackChanged(playbackState){if(playbackState.type!==null){var o={type:'Playback Type',value:playbackState.type,name:this.container.playback.src};this.push(o);}}},{key:'onDVR',value:function onDVR(dvrInUse){var status=dvrInUse?'ON':'OFF';var o={type:'CVR',value:status,name:this.container.playback.src};this.push(o);}},{key:'onPause',value:function onPause(){var o={type:'Pause',value:'',name:this.container.playback.src};this.push(o);}},{key:'onSeek',value:function onSeek(){var o={type:'Seek',value:'',name:this.container.playback.src};this.push(o);}},{key:'onVolumeChanged',value:function onVolumeChanged(e){var o={type:'Volume',value:e.toString(),name:this.container.playback.src};this.push(o);}},{key:'onFullscreen',value:function onFullscreen(){this.fullscreen=!this.fullscreen;var full=this.fullscreen?'ON':'OFF';var o={type:'Fullscreen',value:full,name:this.container.playback.src};this.push(o);}},{key:'push',value:function push(data){var deviceinfo=this.deviceinfo.getdeviceinfo();var mergedInfo=this.utis.mergedict(data,deviceinfo);this.senddata(mergedInfo);}},{key:'senddata',value:function senddata(data){this.socketservice.emitData(data);}}]);return PlayerService;}(_clappr.ContainerPlugin);exports.default=PlayerService;module.exports=exports['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';/**
	 * Module dependencies.
	 */var keys=__webpack_require__(40);var hasBinary=__webpack_require__(17);var sliceBuffer=__webpack_require__(28);var after=__webpack_require__(27);var utf8=__webpack_require__(41);var base64encoder;if(typeof ArrayBuffer!=='undefined'){base64encoder=__webpack_require__(30);}/**
...
/***/ (function(module, exports) {
	...
	"use strict";module.exports=function(a,b){var fn=function fn(){};fn.prototype=b.prototype;a.prototype=new fn();a.prototype.constructor=a;};
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */exports=module.exports=__webpack_require__(39);exports.log=log;exports.formatArgs=formatArgs;exports.save=save;exports.load=load;exports.useColors=useColors;exports.storage='undefined'!=typeof chrome&&'undefined'!=typeof chrome.storage?chrome.storage.local:localstorage();/**
	 * Colors.
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 *
	 * Expose `debug()` as the module.
	 */exports=module.exports=__webpack_require__(48);exports.log=log;exports.formatArgs=formatArgs;exports.save=save;exports.load=load;exports.useColors=useColors;exports.storage='undefined'!=typeof chrome&&'undefined'!=typeof chrome.storage?chrome.storage.local:localstorage();/**
	 * Colors.
	 */exports.colors=['#0000CC','#0000FF','#0033CC','#0033FF','#0066CC','#0066FF','#0099CC','#0099FF','#00CC00','#00CC33','#00CC66','#00CC99','#00CCCC','#00CCFF','#3300CC','#3300FF','#3333CC','#3333FF','#3366CC','#3366FF','#3399CC','#3399FF','#33CC00','#33CC33','#33CC66','#33CC99','#33CCCC','#33CCFF','#6600CC','#6600FF','#6633CC','#6633FF','#66CC00','#66CC33','#9900CC','#9900FF','#9933CC','#9933FF','#99CC00','#99CC33','#CC0000','#CC0033','#CC0066','#CC0099','#CC00CC','#CC00FF','#CC3300','#CC3333','#CC3366','#CC3399','#CC33CC','#CC33FF','#CC6600','#CC6633','#CC9900','#CC9933','#CCCC00','#CCCC33','#FF0000','#FF0033','#FF0066','#FF0099','#FF00CC','#FF00FF','#FF3300','#FF3333','#FF3366','#FF3399','#FF33CC','#FF33FF','#FF6600','#FF6633','#FF9900','#FF9933','#FFCC00','#FFCC33'];/**
	 * Currently only WebKit-based Web Inspectors, Firefox >= v31,
	 * and the Firebug extension (any Firefox version) are known
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * @license  MIT
	 *//* eslint-disable no-proto */'use strict';var base64=__webpack_require__(31);var ieee754=__webpack_require__(44);var isArray=__webpack_require__(45);exports.Buffer=Buffer;exports.SlowBuffer=SlowBuffer;exports.INSPECT_MAX_BYTES=50;/**
...
/***/ (function(module, exports) {
	...
	'use strict';module.exports=function(){if(typeof self!=='undefined'){return self;}else if(typeof window!=='undefined'){return window;}else{return Function('return this')();// eslint-disable-line no-new-func
	}}();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';/**
	 * Module dependencies.
	 */var parser=__webpack_require__(2);var Emitter=__webpack_require__(1);/**
	 * Module exports.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hasCORS=__webpack_require__(43);var globalThis=__webpack_require__(8);module.exports=function(opts){var xdomain=opts.xdomain;// scheme must be same when usign XDomainRequest
	...
	try{if('undefined'!==typeof XDomainRequest&&!xscheme&&enablesXDR){return new XDomainRequest();}}catch(e){}if(!xdomain){try{return new globalThis[['Active'].concat('Object').join('X')]('Microsoft.XMLHTTP');}catch(e){}}};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';/**
	 * Module dependencies.
	 */var debug=__webpack_require__(50)('socket.io-parser');var Emitter=__webpack_require__(1);var binary=__webpack_require__(49);var isArray=__webpack_require__(24);var isBuf=__webpack_require__(23);/**
	 * Protocol version.
	 *
	 * @api public
	 */exports.protocol=4;/**
	...
	if(exports.BINARY_EVENT===p.type||exports.BINARY_ACK===p.type){var start=i+1;while(str.charAt(++i)!=='-'&&i!=str.length){}var buf=str.substring(start,i);if(buf!=Number(buf)||str.charAt(i)!=='-'){throw new Error('Illegal attachments');}p.attachments=Number(buf);}// look up namespace (if any)
	if('/'===str.charAt(i+1)){var start=i+1;while(++i){var c=str.charAt(i);if(','===c)break;if(i===str.length)break;}p.nsp=str.substring(start,i);}else{p.nsp='/';}// look up id
	var next=str.charAt(i+1);if(''!==next&&Number(next)==next){var start=i+1;while(++i){var c=str.charAt(i);if(null==c||Number(c)!=c){--i;break;}if(i===str.length)break;}p.id=Number(str.substring(start,i+1));}// look up json data
	 ...
	 *
	 * @api private
	 */BinaryReconstructor.prototype.finishedReconstruction=function(){this.reconPack=null;this.buffers=[];};function error(msg){return{type:exports.ERROR,data:'parser error: '+msg};}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';/**
	 * Module dependencies
	 */var XMLHttpRequest=__webpack_require__(10);var XHR=__webpack_require__(37);var JSONP=__webpack_require__(36);var websocket=__webpack_require__(38);/**
	 * Export transports.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';/**
	 * Module dependencies.
	 */var Transport=__webpack_require__(9);var parseqs=__webpack_require__(5);var parser=__webpack_require__(2);var inherit=__webpack_require__(3);var yeast=__webpack_require__(25);var debug=__webpack_require__(4)('engine.io-client:polling');/**
	 * Module exports.
	 */module.exports=Polling;/**
	 * Is XHR2 supported?
	 */var hasXHR2=function(){var XMLHttpRequest=__webpack_require__(10);var xhr=new XMLHttpRequest({xdomain:false});return null!=xhr.responseType;}();/**
	 * Polling interface.
	 *
	 * @param {Object} opts
	 * @api private
	...
	if('opening'===self.readyState&&packet.type==='open'){self.onOpen();}// if its a close packet, we close the ongoing requests
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Buffer) {'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/* global Blob File *//*
	 * Module requirements.
	 */var isArray=__webpack_require__(42);var toString=Object.prototype.toString;var withNativeBlob=typeof Blob==='function'||typeof Blob!=='undefined'&&toString.call(Blob)==='[object BlobConstructor]';var withNativeFile=typeof File==='function'||typeof File!=='undefined'&&toString.call(File)==='[object FileConstructor]';/**
	 * Module exports.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/**
	 * Module dependencies.
	 */var eio=__webpack_require__(34);var Socket=__webpack_require__(22);var Emitter=__webpack_require__(1);var parser=__webpack_require__(13);var on=__webpack_require__(21);var bind=__webpack_require__(14);var debug=__webpack_require__(6)('socket.io-client:manager');var indexOf=__webpack_require__(18);var Backoff=__webpack_require__(29);/**
	 * IE6+ hasOwnProperty
	...
	if(false!==this._timeout){var timeout=this._timeout;debug('connect attempt will timeout after %d',timeout);if(timeout===0){openSub.destroy();// prevents a race condition with the 'open' event
	}// set timer
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/**
	 * Module dependencies.
	 */var parser=__webpack_require__(13);var Emitter=__webpack_require__(1);var toArray=__webpack_require__(52);var on=__webpack_require__(21);var bind=__webpack_require__(14);var debug=__webpack_require__(6)('socket.io-client:socket');var parseqs=__webpack_require__(5);var hasBin=__webpack_require__(17);/**
	 * Module exports.
	 ...
	 *
	 * @api public
	 */Socket.prototype.open=Socket.prototype.connect=function(){if(this.connected)return this;this.subEvents();if(!this.io.reconnecting)this.io.open();// ensure open
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Buffer) {'use strict';module.exports=isBuf;var withNativeBuffer=typeof Buffer==='function'&&typeof Buffer.isBuffer==='function';var withNativeArrayBuffer=typeof ArrayBuffer==='function';var isView=function isView(obj){return typeof ArrayBuffer.isView==='function'?ArrayBuffer.isView(obj):obj.buffer instanceof ArrayBuffer;};/**
	 * Returns true if obj is a buffer or an arraybuffer.
	 *
	 * @api private
	 */function isBuf(obj){return withNativeBuffer&&Buffer.isBuffer(obj)||withNativeArrayBuffer&&(obj instanceof ArrayBuffer||isView(obj));}
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(7).Buffer))
...
/***/ (function(module, exports) {
	...
	'use strict';var alphabet='0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_'.split(''),length=64,map={},seed=0,i=0,prev;/**
...
/***/ (function(module, exports) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var Utils=function(){function Utils(){_classCallCheck(this,Utils);}// Calculate a string representation of a node's DOM path.
	_createClass(Utils,[{key:'pathToSelector',value:function pathToSelector(node){if(!node||!node.outerHTML){return null;}var path;while(node.parentElement){var name=node.localName;if(!name)break;name=name.toLowerCase();var parent=node.parentElement;var domSiblings=[];if(parent.children&&parent.children.length>0){for(var i=0;i<parent.children.length;i++){var sibling=parent.children[i];if(sibling.localName&&sibling.localName.toLowerCase){if(sibling.localName.toLowerCase()===name){domSiblings.push(sibling);}}}}if(domSiblings.length>1){name+=':eq('+domSiblings.indexOf(node)+')';}path=name+(path?'>'+path:'');node=parent;}return path;}},{key:'tagConvetor',value:function tagConvetor(e){var obj=e.split('"').join('\'').split('\n').join(" ").split(';').join(",");return obj;}// Generate a JSON version of the event.
	},{key:'serializeEvent',value:function serializeEvent(e){if(e){var o={};for(var key in e){var value=e[key];if(value instanceof Object&&typeof value!=='function'){switch(key){case"path":o[key]=this.pathToSelector(e.path&&e.path.length?e.path[0]:null);break;default:if(value&&value.outerHTML){o[key]=this.tagConvetor(value.outerHTML);}else{o[key]=value?value.toString():null;}break;}}else if(typeof value!=='function'){o[key]=value;}else{o[key]=(typeof value==='undefined'?'undefined':_typeof(value)).toString();}}return o;}return null;}},{key:'generateUUID',value:function generateUUID(){var time=new Date().getTime();if(typeof performance!=='undefined'&&typeof performance.now==='function'){time+=performance.now();}return'xxxxxxxxxxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g,function(c){var random=(time+Math.random()*16)%16|0;time=Math.floor(time/16);return(c==='x'?random:random&0x3|0x8).toString(16);});}},{key:'mergedict',value:function mergedict(){var merged=Object.assign({},arguments[0],arguments[1]);return merged;}}]);return Utils;}();exports.default=Utils;module.exports=exports['default'];

/***/ }),
/* 27 */
/***/ (function(module, exports) {

	'use strict';module.exports=after;function after(count,callback,err_cb){var bail=false;err_cb=err_cb||noop;proxy.count=count;return count===0?callback():proxy;function proxy(err,result){if(proxy.count<=0){throw new Error('after called too many times');}--proxy.count;// after first error, rest are passed to err_cb
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/**
	 * Module dependencies.
	 */var transports=__webpack_require__(15);var Emitter=__webpack_require__(1);var debug=__webpack_require__(4)('engine.io-client:socket');var index=__webpack_require__(18);var parser=__webpack_require__(2);var parseuri=__webpack_require__(19);var parseqs=__webpack_require__(5);/**
	 * Module exports.
	 ...
	 */Socket.Socket=Socket;Socket.Transport=__webpack_require__(9);Socket.transports=__webpack_require__(15);Socket.parser=__webpack_require__(2);/**
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';/**
	 * Module requirements.
	 */var Polling=__webpack_require__(16);var inherit=__webpack_require__(3);var globalThis=__webpack_require__(8);/**
	 * Module exports.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';/* global attachEvent *//**
	 * Module requirements.
	 */var XMLHttpRequest=__webpack_require__(10);var Polling=__webpack_require__(16);var Emitter=__webpack_require__(1);var inherit=__webpack_require__(3);var debug=__webpack_require__(4)('engine.io-client:polling-xhr');var globalThis=__webpack_require__(8);/**
	 * Module exports.
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * Module dependencies.
	 */var Transport=__webpack_require__(9);var parser=__webpack_require__(2);var parseqs=__webpack_require__(5);var inherit=__webpack_require__(3);var yeast=__webpack_require__(25);var debug=__webpack_require__(4)('engine.io-client:websocket');var BrowserWebSocket,NodeWebSocket;if(typeof WebSocket!=='undefined'){BrowserWebSocket=WebSocket;}else if(typeof self!=='undefined'){BrowserWebSocket=self.WebSocket||self.MozWebSocket;}if(typeof window==='undefined'){try{NodeWebSocket=__webpack_require__(56);}catch(e){}}/**
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 *
	 * Expose `debug()` as the module.
	 */exports=module.exports=createDebug.debug=createDebug['default']=createDebug;exports.coerce=coerce;exports.disable=disable;exports.enable=enable;exports.enabled=enabled;exports.humanize=__webpack_require__(11);/**
...
/***/ (function(module, exports) {
	...
	'use strict';/*! https://mths.be/utf8js v2.1.2 by @mathias */var stringFromCharCode=String.fromCharCode;// Taken from https://mths.be/punycode
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/**
	 * Module dependencies.
	 */var url=__webpack_require__(47);var parser=__webpack_require__(13);var Manager=__webpack_require__(20);var debug=__webpack_require__(6)('socket.io-client');/**
	 * Module exports.
	 ...
	 *
	 * @api public
	 */exports.Manager=__webpack_require__(20);exports.Socket=__webpack_require__(22);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';/**
	 * Module dependencies.
	 */var parseuri=__webpack_require__(19);var debug=__webpack_require__(6)('socket.io-client:url');/**
	 * Module exports.
	 */module.exports=url;/**
	 * URL parser.
	 *
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/*global Blob,File*//**
	 * Module requirements
	 */var isArray=__webpack_require__(24);var isBuf=__webpack_require__(23);var toString=Object.prototype.toString;var withNativeBlob=typeof Blob==='function'||typeof Blob!=='undefined'&&toString.call(Blob)==='[object BlobConstructor]';var withNativeFile=typeof File==='function'||typeof File!=='undefined'&&toString.call(File)==='[object FileConstructor]';/**
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 *
	 * Expose `debug()` as the module.
	 */exports=module.exports=__webpack_require__(51);exports.log=log;exports.formatArgs=formatArgs;exports.save=save;exports.load=load;exports.useColors=useColors;exports.storage='undefined'!=typeof chrome&&'undefined'!=typeof chrome.storage?chrome.storage.local:localstorage();/**
	 * Colors.
	 */exports.colors=['#0000CC','#0000FF','#0033CC','#0033FF','#0066CC','#0066FF','#0099CC','#0099FF','#00CC00','#00CC33','#00CC66','#00CC99','#00CCCC','#00CCFF','#3300CC','#3300FF','#3333CC','#3333FF','#3366CC','#3366FF','#3399CC','#3399FF','#33CC00','#33CC33','#33CC66','#33CC99','#33CCCC','#33CCFF','#6600CC','#6600FF','#6633CC','#6633FF','#66CC00','#66CC33','#9900CC','#9900FF','#9933CC','#9933FF','#99CC00','#99CC33','#CC0000','#CC0033','#CC0066','#CC0099','#CC00CC','#CC00FF','#CC3300','#CC3333','#CC3366','#CC3399','#CC33CC','#CC33FF','#CC6600','#CC6633','#CC9900','#CC9933','#CCCC00','#CCCC33','#FF0000','#FF0033','#FF0066','#FF0099','#FF00CC','#FF00FF','#FF3300','#FF3333','#FF3366','#FF3399','#FF33CC','#FF33FF','#FF6600','#FF6633','#FF9900','#FF9933','#FFCC00','#FFCC33'];/**
	 * Currently only WebKit-based Web Inspectors, Firefox >= v31,
	 * and the Firebug extension (any Firefox version) are known
...
/***/ (function(module, exports) {
	...
	"use strict";module.exports=toArray;function toArray(list,index){var array=[];index=index||0;for(var i=index||0;i<list.length;i++){array[i-index]=list[i];}return array;}

/***/ }),
/* 53 */
/***/ (function(module, exports, __webpack_require__) {

	"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _detectGpu=__webpack_require__(33);var _utils=__webpack_require__(26);var _utils2=_interopRequireDefault(_utils);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var DeviceInfo=function(){function DeviceInfo(){_classCallCheck(this,DeviceInfo);this.gpudata=null;this.utils=new _utils2.default();this.getgpuData();}_createClass(DeviceInfo,[{key:"getgpuData",value:function getgpuData(){var _this=this;(0,_detectGpu.getGPUTier)().then(function(data){_this.gpudata=data;});}},{key:"getdeviceinfo",value:function getdeviceinfo(){var o={};o.useragent=this.utils.tagConvetor(navigator.userAgent);o.cookieEnabled=navigator.cookieEnabled;o.cookie=this.getCookies();o.currentpageurl=this.utils.tagConvetor(document.URL);o.referrer=this.utils.tagConvetor(document.referrer);o.gpu=JSON.stringify(this.gpudata);o.screenwidth=screen.width;o.screenheight=screen.height;o.orientation=screen.height<screen.width?'landscape':'portrait';if(window.devicePixelRatio){o.pixelDensity=window.devicePixelRatio;o.retinaDisplay=screen.pixelDensity>1?true:false;}if(window.navigator&&window.navigator.maxTouchPoints){o.maxTouchPoints=window.navigator.maxTouchPoints;}o.datetime=Date.now().toString();return o;}},{key:"getCookies",value:function getCookies(){return this.utils.tagConvetor(document.cookie);}}]);return DeviceInfo;}();exports.default=DeviceInfo;module.exports=exports["default"];

/***/ }),
/* 54 */
/***/ (function(module, exports, __webpack_require__) {

	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _socket=__webpack_require__(46);var _socket2=_interopRequireDefault(_socket);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var SocketService=function(){function SocketService(options,deviceinfo,utils){_classCallCheck(this,SocketService);this.offlineData=[];this.options=options;this.deviceinfo=deviceinfo;this.utis=utils;this.manager=(0,_socket2.default)(options.socketbaseurl,{reconnection:true,transports:['websocket'],upgrade:false,autoConnect:true});this.removeAllListener();this.connectDisconnectSub();}_createClass(SocketService,[{key:'connectDisconnectSub',value:function connectDisconnectSub(){var _this=this;this.manager.on('connect',function(){console.log(" ===>> Socket Connected with id <<=== ");_this.connectdisconnectEvent("connect");});this.manager.on("disconnect",function(){console.log("===>>> Socket Disconnect <<<===");_this.connectdisconnectEvent("disconnect");});}},{key:'removeAllListener',value:function removeAllListener(){this.manager.removeAllListeners();}},{key:'connectdisconnectEvent',value:function connectdisconnectEvent(eventName){var connection=this.sockettoJson(eventName);var deviceinfo=this.deviceinfo.getdeviceinfo();var mergedInfo=this.utis.mergedict(connection,deviceinfo);this.emitData(mergedInfo);if(this.offlineData.length>0){this.sendofflineData();}}},{key:'sockettoJson',value:function sockettoJson(event){var connection={type:event};for(var key in this.manager){var value=this.manager[key];if(key=="io"){connection[key]=this.getIOValue(value);}else if(typeof value==='string'||typeof value==='boolean'||typeof value==='number'){connection[key]=value;}}return connection;}},{key:'getIOValue',value:function getIOValue(e){var o={};for(var key in e){if(key!="0"){var value=e[key];if(value instanceof Object&&typeof value!=='function'){switch(key){case'backoff':o[key]=this.extractData(value);break;case'engine':var enginetmp=this.extractData(value);enginetmp['transport']=this.extractData(value['transport']);o[key]=enginetmp;break;case'opts':o[key]=this.extractData(value);break;case'lastPing':o[key]=this.extractData(value);break;default:break;}}else if(typeof value==='string'||typeof value==='boolean'||typeof value==='number'){o[key]=value;}}}return o;}},{key:'extractData',value:function extractData(data){var o={};if(data){for(var key in data){var value=data[key];if(typeof value!=='undefined'){if(typeof value==='string'||typeof value==='boolean'||typeof value==='number'){o[key]=value;}else if(value instanceof Array){o[key]=value.toString();}}else{o[key]=null;}}}return o;}},{key:'disconnectSocket',value:function disconnectSocket(){this.manager.disconnect();}},{key:'emitData',value:function emitData(requestdata){if(this.manager.connected){this.manager.emit(this.options.channelname,requestdata,function(data){console.log(" ---- Event reached ---- ",data);});}else{this.offlineData.push(requestdata);console.log("Server not connected");}}},{key:'sendofflineData',value:function sendofflineData(){if(this.manager.connected){this.manager.emit(this.options.offlinedatachannelname,this.offlineData,function(data){console.log(" ---- Offline Event reached ---- ",data);});this.offlineData=[];}}}]);return SocketService;}();exports.default=SocketService;module.exports=exports['default'];
